...
function [population,innovation_record]=initial_population_ORI(number_individuals,number_input_nodes,number_output_nodes,vector_connected_input_nodes);
...
vector_connection_from=rep_ORI([vector_connected_input_nodes,number_input_nodes+1],[1 number_output_nodes]);
