...
function [new_population,updated_species_record,updated_innovation_record]=reproduce_ORI(population, species_record, innovation_record, initial, selection, crossover, mutation, speciation, generation, population_size);
